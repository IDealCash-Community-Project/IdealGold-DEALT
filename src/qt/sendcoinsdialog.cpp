...
//            this->setFixedHeight((int)(rec.height()*0.8));
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a IdealGold address (e.g. T8gZqgY4r2RoEdqYk3QsAqFckyf9pRHN6i)"));
#endif
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        else if (!CBitcoinAddress(text.toStdString()).IsValid())
        {
            ...
            ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid IdealGold address"));
        }
        else
        {
