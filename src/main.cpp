...
const string strMessageMagic = "IdealGold Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "IdealGold", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "We Survived 5 16 2018";
        CTransaction txNew;
        txNew.nTime = 1526518854;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1526518854;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 2926067 : 2926067;
        ...
        assert(block.hashMerkleRoot == uint256("0x283e7610f952cd4baa0043a664e6dca98f70412f865de0602d060b4532fa7791"));
...
unsigned char pchMessageStart[4] = { 0x4c, 0x17, 0xf8, 0x5b };
